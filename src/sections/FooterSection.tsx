  ...
  return (
    <footer className="footer">
      <div className="section-container">
        ...
        >
          <div>
            <div className="footer__logo">AMV ODONTOLOGÍA</div>
          ...
          <div className="footer__social">
            <a href="https://instagram.com/amvodontologiard" className="footer__social-link interactive" aria-label="Instagram">
