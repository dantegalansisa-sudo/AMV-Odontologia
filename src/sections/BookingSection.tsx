...
const infoItems = [
  { icon: '📍', label: 'Dirección', value: 'Ave. Bolívar 241, local 1B, La Julia' },
  { icon: '📞', label: 'Teléfono', value: '809-781-0000' },
  { icon: '⏰', label: 'Horario', value: 'Lun - Vie: 8:00 AM - 6:00 PM | Sáb: 8:00 AM - 2:00 PM' },
  { icon: '💬', label: 'WhatsApp', value: 'WhatsApp Directo' },
  { icon: '✉️', label: 'Instagram', value: '@amvodontologiard' },
];
...
export default function BookingSection() {
  ...
  const handleSubmit = (e: FormEvent<HTMLFormElement>) => {
    e.preventDefault();
    window.open('https://wa.me/18097810000', '_blank');
    setSent(true);
