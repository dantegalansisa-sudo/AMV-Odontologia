    ...
    <section className="director section">
      <div className="section-container">
        <div className="director__grid">
          ...
          >
            <img
              src="/imagenes/amv/logo.png"
              alt="AMV Odontología — Director"
          ...
          <div className="director__content">
            ...
            >
              ...
              <span className="director__credential">Más de 20 años</span>
              <span className="director__credential-dot" />
            ...
            >
              "Más de 20 años brindando calidad e innovación en odontología. Nuestra misión es ofrecer tratamientos de alta calidad para todas las áreas de la odontología."
            </motion.blockquote>
            ...
            >
              ...
              <span className="director__signature-role">Director — AMV Odontología</span>
            </motion.div>
          </div>
        </div>
      </div>
