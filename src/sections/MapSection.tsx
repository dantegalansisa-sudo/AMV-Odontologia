        ...
        >
          <div className="map-section__info">
            <div className="map-section__detail">
              ...
              <span className="map-section__detail-value">Ave. Bolívar 241, local 1B, La Julia</span>
            ...
            <div className="map-section__detail">
              ...
              <span className="map-section__detail-value">Sábados: 8:00 AM - 2:00 PM</span>
            ...
            <div className="map-section__detail">
              ...
              <a href="https://instagram.com/amvodontologiard" target="_blank" rel="noopener noreferrer" className="map-section__detail-value map-section__link">@amvodontologiard</a>
              <a href="https://wa.me/18097810000" target="_blank" rel="noopener noreferrer" className="map-section__detail-value map-section__link">WhatsApp Directo</a>
            </div>
          </div>
          ...
          <div className="map-section__embed">
            <iframe
              ...
              title="Ubicación AMV Odontología"
            />
          </div>
        </motion.div>
      </div>
