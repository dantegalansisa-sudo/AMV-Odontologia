...
export const translations: Record<Lang, Record<string, string>> = {
  es: {
    ...
    // Hero
    'hero.tagline': 'Odontología Integral en La Julia',
    'hero.title1': 'TU',
    'hero.title2': 'SONRISA',
    ...
    // Footer
    'footer.tagline': 'Odontología Integral en La Julia',
    'footer.rights': '© 2026 AMV Odontología. Todos los derechos reservados.',
  ...
  en: {
    ...
    // Hero
    'hero.tagline': 'Dental Clinic in La Julia',
    'hero.title1': 'YOUR',
    'hero.title2': 'SMILE',
    ...
    // Footer
    'footer.tagline': 'Dental Clinic in La Julia',
    'footer.rights': '© 2026 AMV Odontología. All rights reserved.',
